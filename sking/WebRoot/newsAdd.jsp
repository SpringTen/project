...
var NewsInfoAddForm = {
	...
	loadImage : function(obj){  
		  ...
		  // ，但是这里只读取第一个   
		  var objUrl = NewsInfoAddForm.getObjectURL(obj.files[0]) ;  
		  if (objUrl) {  
		    // 在这里修改图片的地址属性  
		    $("#img").attr("src", objUrl) ;  
		  }  
...
<body class="easyui-layout" id="main_layout" data-options="fit:true">
	...
	<div data-options="region:'center',border:false">
		<form action="newsController/newsAdd" method="post" id="form" enctype="multipart/form-data">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="vtb">
					<tr>
						<td class="vtbtralignR" style="width: 30%">
							<input type="file" name="file" onchange="javascript:NewsInfoAddForm.loadImage(this);">
						</td>
					...
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<textarea name="newsTitle" style="width: 60%;height: 150px"></textarea>
						</td>
					</tr>
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<textarea name="newsContent" style="width: 60%;height: 300px"></textarea>
						</td>
					</tr>
				</table>
			</div>
	...
	<div data-options="region:'south',border:false" style="height: 30px; background: #e5eff8; overflow: hidden;" align="center">
		...
		<a class="btn btn-success" onclick="javascript:NewsInfoAddForm.formSubmit();">保存</a>
	</div>
</body>
</html>