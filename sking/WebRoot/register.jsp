...
<script>
	...
	function register() {
		...
		var pwd = $('#pwd').val();
		var repwd = $('#repwd').val();
		$.get("userController/isNormal?name=" + name, function(data) {
			if (data != 1) {
				alert("该用户已存在");
			} else if (pwd != repwd) {
				alert("两次输入密码不同");
...
<body>
	...
	<div class="container">
		<div class="register">
			<h1>注册</h1>
			<form id="form" action="userController/userAdd">
				<div class="col-md-6  register-top-grid">

					<div class="mation">
						<span>用户</span> <input id="name" name="userName" type="text">
						<span>手机号码</span> <input name="userPhone" type="text">
					</div>
					<div class="clearfix"></div>
				...
				<div class=" col-md-6 register-bottom-grid">
					...
					<div class="mation">
						<span>密码</span> <input id="pwd" name="userPwd" type="text">
						<span>确认密码</span> <input id="repwd" type="text">
					</div>
				</div>
				<div class="clearfix"></div>
			</form>
			...
			<div class="register-but">
				<form>
					<div class="word-in">
						<a class="acount-btn" style="margin-left: 15px;" onclick="register()">注册</a>
						<div class="clearfix"></div>
					</div>
				</form>
			</div>
