...
function onLoadCustomMainIndexRes(){
	...
	var params = {};
	params.systemCode = IndexCore.systemCode;
...
function addSelfMenu(){
	VortexUtil.goToPage("添加自定义菜单", 'admin/customMainPageResource/add'+'?systemCode='+IndexCore.systemCode);
};
function updateSelfMenu(id){
	VortexUtil.goToPage("修改自定义菜单", 'admin/customMainPageResource/update/' + id+'?systemCode='+IndexCore.systemCode);
};
var cmenu;
