...
var userInSystem = [];
function createUserInSystem(systemCode){
...
function refreshUserInSystemHtml(){
    ...
    $.each(userInSystem, function(i, n) {
    	if(IndexCore.systemCode
    			&&IndexCore.systemCode == n.code){
    ...
    $("#first_menu li").mouseenter(function(){
		$(this).children("div.first-menu-item").addClass("first-menu-item-hover");
		if(!$(this).hasClass("menuCanotClick")){
			$(this).children("div.second-panel").css("display","block");
		}
	});
	$("#first_menu li").mouseleave(function(){
		$(this).children("div.first-menu-item").removeClass("first-menu-item-hover");
		$(this).children("div.second-panel").css("display","none");
	});
