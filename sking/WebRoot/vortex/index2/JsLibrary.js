...
function addIndexJs(urls){
    //在index.jsp中加载的js文件
    urls.push(path +"/vortex/index2/navigation/TreeNavigationV2.js");
    urls.push(path +"/vortex/index2/navigation/ListNavigationV2.js");
    urls.push(path +"/vortex/index2/navigation/MenuTemplateParserFactory.js");
    urls.push(path +"/vortex/index2/navigation/TestMenuTemplate.js");
    urls.push(path +"/vortex/index2/StartUp_v2.js");
    urls.push(path +"/vortex/index2/Loader.js");
    urls.push(path +"/vortex/index2/IndexCore.js");
    urls.push(path +"/vortex/index2/FuncPanelUtil.js");
    
    
    urls.push(path +"/resources/themes/changeskin/css/changeskin.css");
    urls.push(path +"/vortex/index2/skin.js");
}