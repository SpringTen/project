...
(function($){
    function init(target,options){
       ...
       /* var maskMsgCss = {
        ...
        var imageSrc = path + "/vortex/framework/jquery/plugins/mask/mask-loader.gif";
		//var maskm= $('<div class="mask-msg"></div>').html(options.maskMsg).appendTo(wrap).css(maskMsgCss);
        var maskm= $('<div class="mask-msg"><div>' + options.maskMsg  + '</div><p style="text-align: center;"><img src="'+ imageSrc + '" style="margin-top: 2px; margin-left: -10px;" height="11" width="16"/></p></div>').appendTo(wrap).css(maskMsgCss);
		if(target == 'body'){
