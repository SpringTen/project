...
(function($) {
	...
	function _17(_18, _19, el) {
		...
		var _1b = $.extend({}, $.fn.layout.paneldefaults, {
			...
			onOpen : function() {
				...
				if (!t.length) {
					t = $("<a href=\"javascript:void(0)\"></a>").addClass(_1e)
							.appendTo(_1c);
					t.bind("click", {
						dir : dir
					}, function(e) {
								...
								{},
								{
									...
									onStartResize : function(e) {
										...
										if (dir == "north") {
											...
											if (dir == "south") {
												pos.top = parseInt(_20
														.css("top"));
												pos.left = parseInt(_20
														.css("left"));
												pos.width = _20.outerWidth();
												pos.height = _21.height();
											} else {
			...
			if (_2d == "east") {
				...
				if (_2d == "west") {
					...
					if (_2d == "north") {
						...
						_2f.east.add(_2f.west).add(_2f.expandEast).add(
								_2f.expandWest).panel("resize", {
							top : _38 - 1,
							height : hh
						});
						return {
	...
	$.fn.layout = function(_4f, _50) {
		...
		return this.each(function() {
			...
			if (_51) {
				...
				var _52 = $.extend({}, $.fn.layout.defaults, $.fn.layout
						.parseOptions(this), _4f);
				$.data(this, "layout", {
					options : _52,
					panels : {
						center : $(),
		...
		add : function(jq, _57) {
			return jq
					.each(function() {
						_17(this, _57);
						_2(this);
						if ($(this).layout("panel", _57.region)
	...
	$.fn.layout.parseOptions = function(_5b) {
		return $.extend({}, $.parser.parseOptions(_5b, [ {
			fit : "boolean"
		} ]));
	};
	$.fn.layout.defaults = {
	...
	$.fn.layout.parsePanelOptions = function(_5c) {
		var t = $(_5c);
		return $.extend({}, $.fn.panel.parseOptions(_5c), $.parser
				.parseOptions(_5c, [ "region", {
					split : "boolean",
