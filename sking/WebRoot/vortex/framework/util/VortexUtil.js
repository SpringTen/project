VortexUtil = function() {
	...
	;
	/**
	 * * { msg:'', title:'', callback:function(){}, cancelCallback:function(){} }
	 */
	...
	;
	/**
	 * 调用后台SpringMVC Action { url:'', params:{}, isAsync:true, dataType:'json',
				...
				.ajax({
					...
					success : function(data) {
						...
						if (typeof (config.successCallback) == "function") {
							if(data.operateMessage == "没有权限"){
								VortexShow.showInfo({
									infoString: data.operateMessage,
									type: VortexShow.constants.showMsgType.error
								});
							}else{
