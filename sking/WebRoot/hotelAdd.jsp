...
<body class="easyui-layout" id="main_layout" data-options="fit:true">
	<div data-options="region:'north',border:false"
		...
		<div class="vnav vnavfont vnavsize">酒店管理 &gt; 新增酒店信息</div>
		<div class="vsep"></div>
	</div>
	<div data-options="region:'center',border:false">
		<form action="hotelController/hotelAdd" method="post" id="form" enctype="multipart/form-data">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="vtb">
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">
							<img id="img" style="width: 80%;height: 200px;margin-bottom: 20px;">
						</td>
					</tr>
					...
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<input type="text" style="width:200px; height: 30px;" name="hotelName" class="vinput" placeholder="请输入名称">
						</td>
					</tr>
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<textarea name="hotelBrief" style="width: 60%;height: 300px"></textarea>
						</td>
					</tr>
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<input type="text" style="width:200px; height: 30px;" id="hotelAddress" name="hotelAddress" class="vinput" placeholder="请输入名称">
						</td>
					</tr>
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<input type="text" style="width:200px; height: 30px;" id="longitude" name="longitude" class="vinput" placeholder="请输入名称">
						</td>
					</tr>
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<input type="text" style="width:200px; height: 30px;" id="latitude" name="latitude" class="vinput" placeholder="请输入名称">
						</td>
					</tr>
				</table>
			</div>
