...
var HotelList = {
	...
	dataGrid : {
		...
		dataGridUrl : 'hotelController/findPage',
		...
		initDataGrid : function() {
			...
			var columns = [ [ {
				...
				formatter : function(value, row, index) {
									return "<a href='hotelController/findOne?id="+row.hotelId+"' class='btn btn-success'>修改</a>"
									+"&nbsp;&nbsp;&nbsp;&nbsp;<a href='hotelController/deleteById?id="+row.hotelId+"' class='btn'>删除</a>";
								}
			}] ];
			var config = {
				gridId : t.dataGridId,
				...
				columns : columns,
				gridQueryParam : HotelList.getQueryParam
			};
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="vtb">
				<tr style="line-height: 37px;">
					<td width="100%" class="vtbtralignL">&nbsp; 
						...
						<a  class="btn btn-success" onclick="HotelList.doSearch()">查询</a>&nbsp;&nbsp;
						<a  class="btn" onclick="HotelList.clearSearch()">清空</a>&nbsp;&nbsp;
						<a  class="btn"  href="hotelAdd.jsp">新增</a>
					</td>
				</tr>
			</table>		
		</div>
