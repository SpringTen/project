...
},beforePageText:"页",afterPageText:"共 {pages}",displayMsg:'当前显示第<span class="color-blue"> {from} </span>条到 第<span class="color-blue"> {to} </span>条,共<span class="color-blue"> {total} </span>条记录',nav:{first:{iconCls:"pagination-first",handler:function(){
