...
<body class="easyui-layout" id="main_layout" data-options="fit:true">
	<div data-options="region:'north',border:false"
		...
		<div class="vnav vnavfont vnavsize">雪具类型管理 &gt; 修改雪具类型</div>
		<div class="vsep"></div>
	</div>
	<div data-options="region:'center',border:false">
		<form action="typeController/typeUpdate" method="post" id="form">
			<div style="margin-top: 5px; padding-left: 0px; padding-right: 0px;">
				<input name="typeId" value="${type.typeId }" style="display: none;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="vtb">
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<input type="text" style="width:200px; height: 30px;" name="typeName" value="${type.typeName }" class="vinput" placeholder="请输入名称">
						</td>
					</tr>
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<textarea name="typeBrief" style="width: 60%;height: 300px">${type.typeBrief }</textarea>
						</td>
					</tr>
				</table>
			</div>
