...
var SkingAddForm = {
	...
	loadImage : function(obj){  
		  ...
		  // ，但是这里只读取第一个   
		  var objUrl = SkingAddForm.getObjectURL(obj.files[0]) ;  
		  if (objUrl) {  
		    // 在这里修改图片的地址属性  
		    $("#img").attr("src", objUrl) ;  
		  }  
...
<body class="easyui-layout" id="main_layout" data-options="fit:true">
	<div data-options="region:'north',border:false"
		...
		<div class="vnav vnavfont vnavsize">雪具管理 &gt; 新增雪具信息</div>
		<div class="vsep"></div>
	</div>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="vtb">
					<tr>
						<td class="vtbtralignR" style="width: 30%">
							<input type="file" name="file" onchange="javascript:SkingAddForm.loadImage(this);">
						</td>
						<td class="vtbtralignL" style="width: 70%">
							<img id="img" style="width: 200px;height: 200px;margin-bottom: 20px;">
						</td>
					</tr>
					...
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<input type="text" style="width:200px; height: 30px;" name="skingName" class="vinput" placeholder="名称">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<input type="text" style="width:200px; height: 30px;" name="skingCost" class="vinput" placeholder="单价">
						</td>
					</tr>
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<input type="text" style="width:200px; height: 30px;" name="skingCount" class="vinput" placeholder="数量">
						</td>
					</tr>
					<tr>
						...
						<td class="vtbtralignL" style="width: 70%">&nbsp;
							<textarea name="skingBrief" style="width: 60%;height: 150px" placeholder="简介"></textarea>
						</td>
					</tr>
				</table>
			</div>
	...
	<div data-options="region:'south',border:false" style="height: 30px; background: #e5eff8; overflow: hidden;" align="center">
		<a href="#" class="btn" onclick="javascript:SkingAddForm.returnBack();">返回</a> 
		<a class="btn btn-success" onclick="javascript:SkingAddForm.formSubmit();">保存</a>
	</div>
</body>
</html>