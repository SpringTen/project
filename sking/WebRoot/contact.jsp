		...
		<div class="container">
			...
			<div class="contact-grids">
				<div class="contact-form">
					<form action="messageController/contactAdmin" method="post">
						<div class="contact-bottom">
							<div class="col-md-4 in-contact">
								<span>用户名</span>
								<input type="text" style="color: black;" id="name" value="${user.userName }" disabled="disabled">
							</div>
							<div class="col-md-4 in-contact">
								<span>标题</span>
								<input type="text" name="messTitle" style="color: black;">
							</div>
							<div class="clearfix"></div>
						</div>
						...
						<div class="contact-bottom-top">
							<span>内容</span>
							<textarea style="color: black;" name="messContent"></textarea>
						</div>
						<input type="submit" value="发送">
					</form>
					<form action="messageController/myMessageById">
						<input type="submit" value="查看我的留言">
					</form>
				</div>
			</div>
		</div>
