...
var UserList = {
	...
	dataGrid : {
		...
		dataGridUrl : 'userController/findPage',
		...
		initDataGrid : function() {
			...
			var columns = [ [ {
				...
				formatter : function(value, row, index) {
									return "<a href='userController/deleteById?id="+row.userId+"' class='btn'>删除</a>";
								}
			}] ];
			var config = {
				gridId : t.dataGridId,
				...
				columns : columns,
				gridQueryParam : UserList.getQueryParam
			};
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="vtb">
				<tr style="line-height: 37px;">
					<td width="100%" class="vtbtralignL">&nbsp; 
						<span style="text-align: right; margin-left: 10px;">用户名：</span>
						<input type="text" style="width: 150px;" id="name" name="videoCourse" class="vinput" placeholder="请输入">
						<span style="text-align: right; margin-left: 10px;">邮箱：</span>
						<input type="text" style="width: 150px;" id="email" name="videoGrade" class="vinput" placeholder="请输入">&nbsp;&nbsp;
						<a  class="btn btn-success" onclick="UserList.doSearch()">查询</a>&nbsp;&nbsp;
						<a  class="btn" onclick="UserList.clearSearch()">清空</a>
					</td>
				</tr>
			</table>	
		</div>
